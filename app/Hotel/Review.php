...
class Review extends BaseService
{
    ...
    public function insert($roomId, $userId, $rate, $comment)
    {
       ...
       return $this->execute('INSERT INTO review (room_id, user_id, rate, comment) VALUES 
        (:room_id, :user_id, :rate, :comment)', $parameters);
        ...
        $parameters = [
            ...
            ':count_reviews' => $roomAverage['count_reviews'],
        ];
